(() => {
  ...
  const state = {
    ...
    premium:
      localStorage.getItem('cs_premium') === '1',

    learned:
      Number(
        localStorage.getItem('cs_learned') || 0
      ),
  ...
  /*
    IMPORTANT:
    This function puts the same Telegram
    profile photo into the bottom navigation.
  */
      ...
      <article class="lesson-card locked-card">
        ...
        <div class="locked-art">
          ...
          <div>
            ...
            <small>
              Ибора ва талаффуз пас аз
              фаъолсозӣ кушода мешавад.
            </small>
  ...
  function lessonCard(lesson) {
    ...
    return `
      <article class="lesson-card">
        ...
        <div class="chinese">
          ${escapeHtml(lesson.chinese)}
        </div>


        <div class="pinyin">
          ${escapeHtml(lesson.pinyin)}
        </div>


        <div class="translation">
          ${escapeHtml(lesson.translation)}
        </div>
        ...
        <div class="lesson-actions">
          ...
          <button
            class="secondary-btn"
            data-speak="${escapeHtml(lesson.chinese)}"
          >
            🔊 Гӯш кардан
          </button>
  ...
  function render() {
    ...
    /*
      VERY IMPORTANT:
      after every render we update the
      Telegram avatar in bottom navigation.
    */
  ...
  function renderHome() {
    ...
    app.innerHTML = `
      ...
      <section class="hero">
        ...
        <h1>
          Чиниро тавре омӯз,
          ки одамони воқеӣ гап мезананд.
        </h1>


        <p>
          Ибораҳои ҳаррӯза,
          гуфтори табиӣ ва slang —
          бо шарҳи оддӣ ба тоҷикӣ.
        </p>
        ...
        <div class="profile-head">
          ...
          <div class="profile-main">
            ...
            >
              ...
              ${
                connected
                  ? '✓ Telegram аккаунт пайваст аст'
                  : 'Telegram Mini App-ро аз бот кушо'
              }
          ...
          state.premium
            ...
            : `
              ...
              <div class="premium-card">
                ...
                <p>
                  Ҳамаи ибораҳои Premium,
                  гуфтори табиӣ ва slang-ҳои
                  бештарро кушо.
                </p>
  ...
  function findChineseVoice() {
    ...
    return (
      ...
      voices.find(
        voice =>
          /chinese|mandarin|中文|普通话/i.test(
            voice.name
          )
      )
    );
  ...
  function showCheckout() {
    ...
    document
      ...
      .textContent =
      `${state.selectedPlan.title} · ${state.selectedPlan.price}`;
  ...
  async function openCamera() {
    ...
    try {
      ...
      cameraStatus.textContent =
        'Чекро дар чорчӯба гузор ва тугмаи зардро пахш кун.';

    } catch (_) {

      cameraStatus.textContent =
        'Камера дастрас нест. Mini App бояд бо HTTPS кушода шавад ва иҷозаи камера дода шавад.';
    ...
    .addEventListener(
      ...
      () => {
        ...
        document
          ...
          sent
            ? '✓ Заявка фиристода шуд. Админ чекро месанҷад.'
            : 'Барномаро аз Telegram кушо, то заявка фиристода шавад.';
  ...
  document.addEventListener(
    ...
    event => {
      ...
      ripple.style.left =
        `${event.clientX - rect.left - 9}px`;


      ripple.style.top =
        `${event.clientY - rect.top - 9}px`;
